...
export const router = createBrowserRouter([
  { path: "/login", element: <LoginPage /> },
  {
    ...
    children: [
      ...
      { path: "admin", element: <RequireRole roles={["admin", "staff"]}><AdminPage /></RequireRole> },
      { path: "admin/requests/:id", element: <RequireRole roles={["admin", "staff"]}><AdminRequestDetailPage /></RequireRole> },
